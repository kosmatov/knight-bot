...
const processPrice = (data) => {
  ...
  logger.debug('game.processPrice: code ' + typeof(code) + ' "' + code + '" count ' + numbers[0] + ' price ' + numbers[3])
  logger.debug('game.processPrice: resource to process: ' + typeof(exchange_res_id) + ' "' + exchange_res_id + '"')
